# Clinique Dentaire Sabiri - Site Vitrine
...
- **Motion** : Bibliothèque pour les animations fluides et interactives.
...
- **SEO Optimisé** : Structure sémantique HTML5 pour un meilleur référencement local (Forest/Bruxelles).
- **Système de Gestion de Contenu (CMS) Admin** : Un tableau de bord sécurisé accessible via `/admin` permettant de modifier les textes principaux et d'activer une bannière d'urgence.
- **Sections Complètes** : Accueil, Services, À Propos, Technologie, Avis Patients et Contact avec formulaire.
...
- `src/App.tsx` : Point d'entrée principal et gestion des routes.
- `index.css` : Styles globaux et configuration Tailwind.

---
**© 2026 Clinique Dentaire Sabiri. Créé par MAAYOUD.B.**
